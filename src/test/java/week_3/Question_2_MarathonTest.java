...
public class Question_2_MarathonTest  {
    ...
    public void testTrainingSchedule() {
        ...
        try {
            ...
            fail("Check your trainingSchedule method has the right name, right parameters, right return type, and does not throw any errors. Check the instructions for the types required.");
        }
