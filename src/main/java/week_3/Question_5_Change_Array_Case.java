...
public class Question_5_Change_Array_Case {

    public static void main(String[] args) {
        
        // You can call your new convertArrayCase() method with these example arrays.

        String[] test1 = { "lower", "upper", "MiXeD" };
        String[] test2 = { "a", "b", "c", "d" };
        String[] test3 = { "A", "B", "C", "D" };
        String[] test4 = { "1234", "@#$%", "\n", "----" };  // Not characters with upper or lower cases
